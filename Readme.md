...
- [3. METAR Fetcher – StreamerBot Edition](#3-metar-fetcher--streamerbot-edition)
- [4. Key Features](#4-key-features)
- [5. Why This Script?](#5-why-this-script)
- [6. Example Usage](#6-example-usage)
  - [6.1. Twitch Chat Command](#61-twitch-chat-command)
  - [6.2. Bot Response in Chat](#62-bot-response-in-chat)
- [7. Flight Category Emoji Legend](#7-flight-category-emoji-legend)
...
- [12. Links to Related Resources](#12-links-to-related-resources)
- [13. Contributing](#13-contributing)
- [14. Behind the Scenes: How It Works](#14-behind-the-scenes-how-it-works)
...
## 3. METAR Fetcher – StreamerBot Edition
...
### 6.1. Twitch Chat Command

```bash
!metar ksea
```

### 6.2. Bot Response in Chat
...
## 7. Flight Category Emoji Legend
...
## 8. How to Set Up in StreamerBot

### 8.1. Step 1: Add the C# Action
...
## 14. Behind the Scenes: How It Works
